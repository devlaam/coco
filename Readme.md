CoCo Json: A simple extension to Play Json.
===========================================

This library can be used for the coast to coast application
...
* I have the feeling multiple key implementation of json in Play is not according to the rfc4627 [1], or, at least, it is not consistently implemented over the different operators.
* But most important, I needed a immutable json library that was easily modifiable  
